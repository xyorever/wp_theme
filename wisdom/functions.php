...
function resume_init() {
  $labels = array(
    'name' => _x('Résumés', 'post type general name'),
    'singular_name' => _x('Résumé', 'post type singular name'),
    'add_new' => _x('Add New', 'résumé'),//
    'add_new_item' => __('Add New Résumé'),
    'edit_item' => __('Edit Résumé'),
    'new_item' => __('New Résumé'),
    'all_items' => __('All Résumés'),
    'view_item' => __('View Résumé'),
    'search_items' => __('Search Résumés'),
    'not_found' =>  __('No résumés found'),//
    'not_found_in_trash' => __('No résumés found in Trash'), //
    'parent_item_colon' => '',
    'menu_name' => __('Résumés')
